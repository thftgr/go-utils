...
func TestParseContentType(t *testing.T) {
	tests := []struct {
		...
		{"TestParseContentType-001", "application/json; charset=utf-8", &ContentType{
			ContentType: "application/json",
			Type:        "application",
			Subtype:     "json",
			Charset:     "utf-8",
		}},
		{"TestParseContentType-002", "application/json", &ContentType{
			ContentType: "application/json",
			Type:        "application",
			Subtype:     "json",
		}},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := ParseContentType(tt.contentType); !reflect.DeepEqual(got, tt.want) {
...
// test content-type, accept
//text/html, application/xhtml+xml, application/xml;q=0.9, */*;q=0.8
//text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=1,*/*;q=2.1
//*/*
